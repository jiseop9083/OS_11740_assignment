   ...
   e:	31 db                	xor    %ebx,%ebx
{
  ...
  14:	68 05 08 00 00       	push   $0x805
  19:	6a 01                	push   $0x1
  1b:	e8 90 04 00 00       	call   4b0 <printf>
  20:	83 c4 10             	add    $0x10,%esp
    thread_create(&thread[i], thread_main, (void *)i);
  23:	83 ec 04             	sub    $0x4,%esp
  26:	8d 04 9d 6c 0b 00 00 	lea    0xb6c(,%ebx,4),%eax
  2d:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
...
00000070 <thread_main>:
{
  ...
  c3:	6a 01                	push   $0x1
    char *args[2] = {pname, 0};
  c5:	c7 45 f0 e9 07 00 00 	movl   $0x7e9,-0x10(%ebp)
  cc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    printf(1, "Executing...\n");
  d3:	e8 d8 03 00 00       	call   4b0 <printf>
    exec(pname, args);
  d8:	8d 45 f0             	lea    -0x10(%ebp),%eax
  db:	59                   	pop    %ecx
  dc:	5b                   	pop    %ebx
  dd:	50                   	push   %eax
  de:	68 e9 07 00 00       	push   $0x7e9
 ...
 651:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 80 0b 00 00    	mov    %edx,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 80 0b 00 00    	mov    0xb80,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 84 0b 00 00       	mov    $0xb84,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 7c2:	00 00 00 
    if(p->s.size >= nunits){
