...
int main() {
  ...
  21:	e8 1d 03 00 00       	call   343 <getpid>
  26:	83 c4 0c             	add    $0xc,%esp
  29:	50                   	push   %eax
  2a:	68 a5 07 00 00       	push   $0x7a5
  2f:	6a 01                	push   $0x1
  31:	e8 ea 03 00 00       	call   420 <printf>
	printf(1, "My gpid is %d\n", getgpid());
  36:	e8 28 03 00 00       	call   363 <getgpid>
  3b:	83 c4 0c             	add    $0xc,%esp
  3e:	50                   	push   %eax
  3f:	68 b3 07 00 00       	push   $0x7b3
  44:	6a 01                	push   $0x1
  46:	e8 d5 03 00 00       	call   420 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb c2 07 00 00       	mov    $0x7c2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f5:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 616:	73 10                	jae    628 <free+0x38>
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 649:	5d                   	pop    %ebp
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 690:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d9:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
 ...
 702:	e8 e9 fe ff ff       	call   5f0 <free>
  return freep;
 707:	a1 7c 0a 00 00       	mov    0xa7c,%eax
 ...
 734:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 737:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 76b:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 772:	00 00 00 
    if(p->s.size >= nunits){
