...
int main(int argc, char *argv[]) {
  ...
  1d:	e8 f1 02 00 00       	call   313 <getpid>
  22:	83 c4 0c             	add    $0xc,%esp
  25:	50                   	push   %eax
  26:	68 65 07 00 00       	push   $0x765
  2b:	6a 01                	push   $0x1
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 d4 07 00 00 	movzbl 0x7d4(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 7c 07 00 00 	jmp    *0x77c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 73 07 00 00       	mov    $0x773,%edx
        while(*s != 0){
